        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Select name="gender" onValueChange={(value) => handleChange({ target: { name: 'gender', value } })} value={formData.gender}>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select name="status" onValueChange={(value) => handleChange({ target: { name: 'status', value } })} value={formData.status}>
                <SelectTrigger>
          ...
          <DialogFooter>
            ...
            <Button variant="secondary" size="lg" type="submit" className="w-full sm:w-auto">Save Changes</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
